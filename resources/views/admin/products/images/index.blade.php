    ...
    <div class="container">
        <div class="section text-center">
            <h2 class="title">Imagenes de producto "{{$product->name}}"</h2>
                    ...
                    <form method="post" action="" enctype="multipart/form-data"> <!--El action va a asumir que se va a hacer en la ruta que esta-->
                        {{csrf_field()}}
                        <button type="submit" class="btn btn-primary btn-round">Subir nueva imagen</button>
                        <a href={{ url('/admin/products/create') }} class="btn btn-default btn-round">Volver al listado de productos</a>
